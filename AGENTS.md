...
- `prod` — production branch. Vercel tracks this in **Settings → Environments → Production → Branch Tracking**; pushes here deploy to `sheltermark.vercel.app`. Protected by a GitHub ruleset: no force-push, no deletion.
